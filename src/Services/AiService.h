...
//   "早上好，小钦。昨天你的OpenCode改代码8小时。你的小说文档昨天修改了三次。另外……你又凌晨三点睡觉。"
...
public:
    ...
    // Gitee update config passthrough
    Q_INVOKABLE QString giteeRepo();
    Q_INVOKABLE QString giteeToken();
    Q_INVOKABLE void setGiteeRepo(const QString &v);
    Q_INVOKABLE void setGiteeToken(const QString &v);
