...
// Auto-update against a Gitee release (private repo supported via access_token).
...
private:
    ...
    QString authUrl(const QString &base) const;

    bool m_available = false;
    QString m_latest;
    QString m_url;              // exe asset download api url (with token)
    QString m_releaseId;        // gitee release id
    QString m_assetId;          // gitee asset id
