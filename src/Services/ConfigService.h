...
public:
    ...
    void setGiteeRepo(const QString &v) { m_giteeRepo = v; save(); }
    void setGiteeToken(const QString &v) { m_giteeToken = v; save(); }
...
private:
    ...
    QString m_giteeRepo = "xiao-qin-uwu/xiaoqintools";
